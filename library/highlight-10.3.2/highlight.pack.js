...
contains:b}}}());hljs.registerLanguage("powershell",function(){"use strict";return function(e){
var n={$pattern:/-?[A-z\.\-]+\b/,
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}}());hljs.registerLanguage("c-like",function(){"use strict";return function(e){
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}}());hljs.registerLanguage("cpp",function(){"use strict";return function(e){
var i=e.requireLanguage("c-like").rawDefinition();return i.disableAutodetect=!1,
i.name="C++",i.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],i}}());hljs.registerLanguage("plaintext",function(){"use strict";return function(t){
...
starts:{end:/$/,contains:[i,c,r,t,l,s]}}]}}}());hljs.registerLanguage("bash",function(){"use strict";return function(e){
